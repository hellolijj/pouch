...
// imagePruneDescription is used to remove all unused images.
var imagePruneDescription = "Remove all unused images"

// ImagePruneCommand use to remove all stopped images.
...
// runImagePrune is used to remove unused images.
